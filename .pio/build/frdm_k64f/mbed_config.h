...
#define MBED_CONF_SD_SPI_CLK                                                  SPI_SCK                                                                                          // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_CS                                                   SPI_CS                                                                                           // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_MISO                                                 SPI_MISO                                                                                         // set by library:sd[K64F]
#define MBED_CONF_SD_SPI_MOSI                                                 SPI_MOSI                                                                                         // set by library:sd[K64F]
